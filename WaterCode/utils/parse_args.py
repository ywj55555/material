...
def parse_args():
    ...
    parser.add_argument('--lr','-l',default=0.001, type=float,help = "The learning rate")
    parser.add_argument('--batchsize','-b', default=1,type=int,help = "The batchsize of model")# 步骤二，后面的help是我的描述
    parser.add_argument('--epoch','-e', default=300, type=int, help="The epoch of train")
    parser.add_argument('--nora', '-n', default=False, type=bool, help="normalize data")
    parser.add_argument('--model_select', '-m', default=3, type=int, help="normalize data")
    ...
    parser.add_argument('--band_number', '-dim', default=8, type=int, help="bands number")#9
    parser.add_argument('--train_set', '-tr', default='', type=str, help="which train set")
    parser.add_argument('--num_workers', '-nw', default=8, type=int, help="which train set")
    parser.add_argument('--min_kept', '-k', default=500000, type=int, help="Don't know yet")
...
def parse_test_args():
    ...
    parser.add_argument('--test_batch','-b', default=1,type=int,help = "The batchsize of predict")# 步骤二，后面的help是我的描述
    args = parser.parse_args()                                       # 步骤三
    return args
