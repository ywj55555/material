...
class Two_CNN(nn.Module):#No Attention, three losses
    def __init__(self, band, classes):
        ...
        self.conv11 = nn.Conv3d(1,20,kernel_size=(16,1,1), stride=(2,1,1), padding=0)  #20, (16,1,1)
        self.conv12 = nn.Conv3d(20,20,kernel_size=(16,1,1), stride=(2,1,1), padding=0)#20, (16,1,1)
        self.pool1 = nn.MaxPool3d(kernel_size=(16,1,1), stride=(1,1,1))#(5,1,1)
        ...
        self.conv22 = nn.Conv2d(in_channels=30, out_channels=30, padding=1,
                                kernel_size=3, stride=1)#30, (3,3)
        self.pool2 =  nn.MaxPool2d(kernel_size=3, padding=1, stride=1)#(2,2)

        self.conv31 = nn.Conv2d(in_channels=150, out_channels=400, padding=0,
