...
csv2_save_path = log+'mulpng'+file_str[FOR_TESTSET]+'addsh_data.csv'
model_path = '/home/cjl/ywj_code/code/ori_multi-category/ori_model_add_sh/'
LEN = 5
test_batch = 3
...
#     model = MaterialSubModel(in_channels=20, out_channels=4, kernel_size = 5,padding_mode='reflect',mid_channels_1=24, mid_channels_2=12, mid_channels_3=6).cuda()
    ...
    count_right = 0
    count_tot = 0
    result_dir = './output_mulpng_addsh_data/' + epoch + '/'+file_str[FOR_TESTSET]+'/'
