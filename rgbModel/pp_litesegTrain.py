...
model_path = './PPLiteSeg_HF' + str(min_kept) + '_' + str(mLearningRate) + '_' + str(mtrainBatchSize) + '/'
...
if __name__ == '__main__':
    ...
    trainDataset = Dataset_RGB(HfTrain, png_path, waterLabelPath)
    testDataset = Dataset_RGB(waterFileHZ, hz_png_path, hz_label)
