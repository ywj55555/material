...
png_path = '/home/cjl/data/sensor6/rgb_113/'
...
tif_dir_113 = '/home/cjl/data/sensor6/tif_data_113/'
...
# MaterialModel input size in training = (m, channels, length, length)  (length == 11)
    ...
    result_dir = './output_6sensor_113/' + epoch + '/test_lr-4/'
    mkdir(result_dir)
    for filename in file_list:
        img0 = cv2.imread(tif_dir_113 + filename[:-4] + '.tif', -1)
        img1 = cv2.imread(tif_dir_113 + filename[:-5] + '1.tif', -1)
        img2 = cv2.imread(tif_dir_113 + filename[:-5] + '2.tif', -1)
        img3 = cv2.imread(tif_dir_113 + filename[:-5] + '3.tif', -1)
        img4 = cv2.imread(tif_dir_113 + filename[:-5] + '4.tif', -1)
        img5 = cv2.imread(tif_dir_113 + filename[:-5] + '5.tif', -1)
        ...
        imgGt = cv2.imread(png_path + filename)
        imgGt = imgGt[5:-5, 5:-5]
        ...
        cv2.imwrite(result_dir + filename[:-4] + '.jpg', imgRes)
