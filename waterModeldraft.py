...
model_save = "./model/" + model_size[model_select - 1] + "_" + str(mBatchSize) + "_" + str(mLearningRate) + "_" + str(intervalSelect) + "_" + str(nora) + \
...
if __name__ == '__main__':
    ...
    mkdir(save_npy_path)
    save_trainData_npy_path = save_npy_path + bands_str + str(intervalSelect) + "_"  + str(featureTrans) + "_" + activa + '_draft.npy'
    ...
    if model_select == 2:
        model = MaterialBigModel(bands_num, class_nums, len_features = 32,mid_channel1 = 16).cuda()
    else:
